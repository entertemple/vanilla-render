...
}: {gradient: string;className?: string;parallaxY?: any;}) {
  return (
    <motion.div
...
}: {title: string;description: string;inView: boolean;delay?: number;}) {
  return (
    <motion.div
    ...
    <div className="fixed inset-0 z-50 bg-cnx-light-grey">
      ...
      <div
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-[80px]">
          ...
          <motion.p
            className="text-cnx-black mt-6 text-center text-4xl"
            style={{
              fontFamily: FONT_FAMILY,
