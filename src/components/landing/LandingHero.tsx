...
export default function LandingHero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-20 pt-[100px] pb-20">
      <motion.div
      ...
      >
        ...
        {/* Divider */}
        <div className="flex items-center gap-4 w-full max-w-[320px] mb-4">
